...
threads = 16
num_runs = 20;
mat_loc = "/home/lane/matrices/rcm";
spmv_path = "/home/lane/gpu-spmv-csr";
record_file = "/home/lane/hipsparse.csv";


#spmv_default_omp = ["acc-spmv-csr", "acc-spmv-csrk"];
#spmv_default_omp = ["acc-spmv-csrk"];
spmv_default_omp = ["hipsparse-spmv"];
spmv_default_omp_schedule = ["hipsparse"];
            ...
            for sch in spmv_default_omp_schedule:
                ...
                for chunk in spmv_default_omp_chunk:
                    ...
                    for supRowSizeI in range(len(sizes)):
                        ...
                        #write out to the 
                        fid_rec.write(i + ", " + mat + ", " + sch + ", " + str(chunk) + ", " + str(threads) + ", " + min_val + ", " +  max_val + ", " + avg_val + ", \n");
