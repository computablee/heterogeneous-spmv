...
record_file = "/home/lane/cpu_spmv.csv";


spmv_default_omp = ["spmv-csr"];
            ...
            for sch in spmv_default_omp_schedule:
                  ...
                  for thread in threads:
                    #iterate over all cores
                        print(i + "_" + mat + "_" + sch + "_" + str(thread));
                        ...
                        #write out to the 
                        fid_rec.write(i + ", " + mat + ", " + sch + ", " + str(thread) + ", " + min_val + ", " +  max_val + ", " + avg_val + ", \n");
                        
                        #print(i + ", " + mat + ", " + sch + ", " + str(chunk) + ", " + str(thread) + ", " + min_val + ", " +  max_val + ", " + avg_val + ", \n");
                        print(i + ", " + mat + ", " + sch + ", " + str(thread) + ", " + min_val + ", " +  max_val + ", " + avg_val + ", \n");
